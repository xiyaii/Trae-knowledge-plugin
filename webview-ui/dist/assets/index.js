(function() {
  ...
  function useVsCode() {
    ...
    const sendQuery = reactExports.useCallback((query) => {
      var _a;
      if (!query.trim()) return;
      (_a = vscodeRef.current) == null ? void 0 : _a.postMessage({ type: "query", query });
    }, []);
    const sendFeedback = reactExports.useCallback(
      (msgId, feedback, reason) => {
        var _a;
        if (!msgId) return;
        (_a = vscodeRef.current) == null ? void 0 : _a.postMessage({ type: "feedback", msgId, feedback, reason });
      },
      []
    );
  ...
  function ChatMessageView({
    ...
    const [showReason, setShowReason] = reactExports.useState(false);
    const [selectedReasons, setSelectedReasons] = reactExports.useState([]);
    ...
    const handleLike = () => {
      ...
      if (isLocked) return;
      throttle(() => {
        onFeedback == null ? void 0 : onFeedback(msg.msgId, "like");
        setShowReason(false);
      });
    };
    const handleDislike = () => {
      ...
      if (!isDislike) {
        throttle(() => {
          onFeedback == null ? void 0 : onFeedback(msg.msgId, "dislike");
        });
      }
      setShowReason(true);
    };
    const submitReason = () => {
      ...
      throttle(() => {
        ...
        onFeedback == null ? void 0 : onFeedback(msg.msgId, "dislike", reasons.join(";"));
        setShowReason(false);
      });
    };
    const toggleReason = (r2) => {
      setSelectedReasons(
        (prev) => prev.includes(r2) ? prev.filter((x2) => x2 !== r2) : [...prev, r2]
      );
    };
    const hasError = feedbackError === msg.msgId;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `message ${msg.role}${msg.error ? " error" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bubble", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { remarkPlugins: [remarkGfm], children: msg.content }) }),
      msg.source && !msg.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "source", children: [
        "来源: ",
        msg.source.doc_name,
        " · 得分 ",
        msg.source.score.toFixed(4)
      ] }),
      canFeedback && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "feedback-bar", children: [
        ...
        msg.feedback && !showReason && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "fb-done", children: [
          msg.feedback === "like" ? "已点赞" : "已点踩",
          isDislike && " · 点击 👎 可修改原因"
        ] }),
        hasError && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "fb-error", children: "反馈失败，请重试" }),
        showReason && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reason-panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reason-options", children: DISLIKE_REASONS.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "reason-chip", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "checkbox",
                checked: selectedReasons.includes(r2),
                onChange: () => toggleReason(r2)
              }
            ),
            r2
          ] }, r2)) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "reason-submit", onClick: submitReason, children: isDislike ? "更新原因" : "提交原因" })
        ] })
      ] })
    ] });
  }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "messages", children: [
        messages.length === 0 && !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "empty-state", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "输入问题开始问答" })
        ] }),
        messages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ChatMessageView, { msg, onFeedback: sendFeedback, feedbackError }, i)),
        loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loading", children: [
